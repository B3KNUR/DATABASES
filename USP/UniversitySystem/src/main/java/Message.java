...
public class Message {
    ...
    public static Message fetchFromDatabase(Connection connection, int id) throws SQLException {
    ...
    public void updateContentInDatabase(Connection connection) throws SQLException {

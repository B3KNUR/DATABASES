...
public class Book {
    ...
    public static Book fetchFromDatabase(Connection connection, String code) throws SQLException {
    ...
    public void updateAvailabilityInDatabase(Connection connection) throws SQLException {
